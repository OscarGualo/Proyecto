...
public class ProductoEspecifico extends ProductoBase {
    ...
    public ProductoEspecifico(String codigo, String marca, String presentacion, double costo, double precioVenta,
            int stock, String grupo, String categoria, String productoEspecifico, double descuento) {
        // Llamar al constructor de la clase base (ProductoBase) para inicializar los
        // valores
